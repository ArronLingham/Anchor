...
enum SettingsSectionIndex {
    ...
    static let sections: [SettingsTab: [Section]] = [
        ...
        .launcher: [.init(title: "Launcher", anchor: "Enable Launcher"), .init(title: "App switcher", anchor: "Enable app switcher"), .init(title: "Grid", anchor: "Show all apps when the field is empty"), .init(title: "Panel", anchor: "Fill the screen"), .init(title: "Widgets", anchor: "Clock"), .init(title: "Results", anchor: "Evaluate arithmetic"), .init(title: "Index", anchor: "Rebuild index now")],
