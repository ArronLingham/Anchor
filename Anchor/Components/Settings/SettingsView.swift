...
struct SettingsView: View {
    ...
    private var settingsSearchIndex: [SettingsSearchEntry] {
        [
            ...
            SettingsSearchEntry(tab: .general, title: "Show a pill on displays without a notch", keywords: ["external display", "external monitor", "pill", "second monitor", "second screen", "multi-display", "non-notch", "no notch", "permanent pill", "hover to open", "always show on external displays"], highlightID: SettingsTab.general.highlightID(for: "Show a pill on displays without a notch")),
            ...
            // ---- Rows that existed in the panes but were not searchable ----
            //
            // The index above is hand-maintained, and had drifted badly: 317
            // rows carry a .settingsHighlight(id:) and only 217 were listed, so
            // 121 settings could not be found by searching for them.
            // These entries are generated from the panes' own highlight ids, so
            // the title and the scroll target cannot disagree.
            // tests/run_settingssearch_tests.sh fails if the two drift again.
            SettingsSearchEntry(tab: .appearance, title: "Closed notch / pill width", keywords: ["closed", "notch", "pill", "width", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Closed notch / pill width")),
            SettingsSearchEntry(tab: .appearance, title: "Copy as", keywords: ["copy", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Copy as")),
            SettingsSearchEntry(tab: .appearance, title: "Customize physical notch width", keywords: ["customize", "physical", "notch", "width", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Customize physical notch width")),
            SettingsSearchEntry(tab: .appearance, title: "Expanded notch width", keywords: ["expanded", "notch", "width", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Expanded notch width")),
            SettingsSearchEntry(tab: .appearance, title: "Lock screen glass mode", keywords: ["lock", "screen", "glass", "mode", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Lock screen glass mode")),
            SettingsSearchEntry(tab: .appearance, title: "Lock screen material", keywords: ["lock", "screen", "material", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Lock screen material")),
            SettingsSearchEntry(tab: .appearance, title: "Music panel variant (appearance)", keywords: ["music", "panel", "variant", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Music panel variant (appearance)")),
            SettingsSearchEntry(tab: .appearance, title: "Open and close", keywords: ["open", "close", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Open and close")),
            SettingsSearchEntry(tab: .appearance, title: "Screen colour picker", keywords: ["screen", "colour", "picker", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Screen colour picker")),
            SettingsSearchEntry(tab: .appearance, title: "Timer widget variant (appearance)", keywords: ["timer", "widget", "variant", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Timer widget variant (appearance)")),
            SettingsSearchEntry(tab: .appearance, title: "Tint the player with the album art", keywords: ["tint", "player", "album", "art", "appearance"], highlightID: SettingsTab.appearance.highlightID(for: "Tint the player with the album art")),
            SettingsSearchEntry(tab: .battery, title: "Record battery history", keywords: ["record", "battery", "history"], highlightID: SettingsTab.battery.highlightID(for: "Record battery history")),
            SettingsSearchEntry(tab: .calendar, title: "Calendar App", keywords: ["calendar", "app"], highlightID: SettingsTab.calendar.highlightID(for: "Calendar App")),
            SettingsSearchEntry(tab: .calendar, title: "Enable third-party calendar app launch", keywords: ["third-party", "calendar", "app", "launch"], highlightID: SettingsTab.calendar.highlightID(for: "Enable third-party calendar app launch")),
            SettingsSearchEntry(tab: .calendar, title: "Fantastical Default View", keywords: ["fantastical", "default", "view", "calendar"], highlightID: SettingsTab.calendar.highlightID(for: "Fantastical Default View")),
            SettingsSearchEntry(tab: .claudeUsage, title: "Resume the halted session automatically", keywords: ["resume", "halted", "session", "automatically", "claude usage"], highlightID: SettingsTab.claudeUsage.highlightID(for: "Resume the halted session automatically")),
            SettingsSearchEntry(tab: .claudeUsage, title: "Resume with", keywords: ["resume", "claude usage"], highlightID: SettingsTab.claudeUsage.highlightID(for: "Resume with")),
            SettingsSearchEntry(tab: .claudeUsage, title: "Show in the notch", keywords: ["notch", "claude usage"], highlightID: SettingsTab.claudeUsage.highlightID(for: "Show in the notch")),
            SettingsSearchEntry(tab: .claudeUsage, title: "Watch for usage limits", keywords: ["watch", "usage", "limits", "claude usage"], highlightID: SettingsTab.claudeUsage.highlightID(for: "Watch for usage limits")),
            SettingsSearchEntry(tab: .claudeUsage, title: "ntfy topic", keywords: ["ntfy", "topic", "claude usage"], highlightID: SettingsTab.claudeUsage.highlightID(for: "ntfy topic")),
            SettingsSearchEntry(tab: .clipboard, title: "Also clear on sleep and lock", keywords: ["also", "clear", "sleep", "lock", "clipboard"], highlightID: SettingsTab.clipboard.highlightID(for: "Also clear on sleep and lock")),
            SettingsSearchEntry(tab: .clipboard, title: "Clean tracking parameters from copied links", keywords: ["clean", "tracking", "parameters", "copied", "links", "clipboard"], highlightID: SettingsTab.clipboard.highlightID(for: "Clean tracking parameters from copied links")),
            SettingsSearchEntry(tab: .clipboard, title: "Empty the clipboard after a delay", keywords: ["empty", "clipboard", "after", "delay"], highlightID: SettingsTab.clipboard.highlightID(for: "Empty the clipboard after a delay")),
            SettingsSearchEntry(tab: .downloads, title: "Download indicator style", keywords: ["download", "indicator", "style", "downloads"], highlightID: SettingsTab.downloads.highlightID(for: "Download indicator style")),
            SettingsSearchEntry(tab: .downloads, title: "Enable download detection", keywords: ["download", "detection", "downloads"], highlightID: SettingsTab.downloads.highlightID(for: "Enable download detection")),
            SettingsSearchEntry(tab: .downloads, title: "Icon", keywords: ["icon", "downloads"], highlightID: SettingsTab.downloads.highlightID(for: "Icon")),
            SettingsSearchEntry(tab: .gemini, title: "AI Assistant", keywords: ["assistant", "gemini"], highlightID: SettingsTab.gemini.highlightID(for: "AI Assistant")),
            SettingsSearchEntry(tab: .general, title: "Count fullscreen apps as desktops", keywords: ["count", "fullscreen", "apps", "desktops", "general"], highlightID: SettingsTab.general.highlightID(for: "Count fullscreen apps as desktops")),
            SettingsSearchEntry(tab: .general, title: "Eye break reminders", keywords: ["eye", "break", "reminders", "general"], highlightID: SettingsTab.general.highlightID(for: "Eye break reminders")),
            SettingsSearchEntry(tab: .general, title: "File shelf", keywords: ["file", "shelf", "general"], highlightID: SettingsTab.general.highlightID(for: "File shelf")),
            SettingsSearchEntry(tab: .general, title: "Gesture skip behavior", keywords: ["gesture", "skip", "behavior", "general"], highlightID: SettingsTab.general.highlightID(for: "Gesture skip behavior")),
            SettingsSearchEntry(tab: .general, title: "Horizontal media gestures", keywords: ["horizontal", "media", "gestures", "general"], highlightID: SettingsTab.general.highlightID(for: "Horizontal media gestures")),
            SettingsSearchEntry(tab: .general, title: "Ignore repeats within", keywords: ["ignore", "repeats", "within", "general"], highlightID: SettingsTab.general.highlightID(for: "Ignore repeats within")),
            SettingsSearchEntry(tab: .general, title: "Invert horizontal scrolling", keywords: ["invert", "horizontal", "scrolling", "general"], highlightID: SettingsTab.general.highlightID(for: "Invert horizontal scrolling")),
            SettingsSearchEntry(tab: .general, title: "Invert mouse wheel scrolling", keywords: ["invert", "mouse", "wheel", "scrolling", "general"], highlightID: SettingsTab.general.highlightID(for: "Invert mouse wheel scrolling")),
            SettingsSearchEntry(tab: .general, title: "Lock clipboard history", keywords: ["lock", "clipboard", "history", "general"], highlightID: SettingsTab.general.highlightID(for: "Lock clipboard history")),
            SettingsSearchEntry(tab: .general, title: "Lock notes", keywords: ["lock", "notes", "general"], highlightID: SettingsTab.general.highlightID(for: "Lock notes")),
            SettingsSearchEntry(tab: .general, title: "Mouse side buttons go back and forward", keywords: ["mouse", "side", "buttons", "back", "forward", "general"], highlightID: SettingsTab.general.highlightID(for: "Mouse side buttons go back and forward")),
            SettingsSearchEntry(tab: .general, title: "Settle for", keywords: ["settle", "general"], highlightID: SettingsTab.general.highlightID(for: "Settle for")),
            SettingsSearchEntry(tab: .general, title: "Show battery indicator in Minimalistic UI", keywords: ["battery", "indicator", "minimalistic", "general"], highlightID: SettingsTab.general.highlightID(for: "Show battery indicator in Minimalistic UI")),
            SettingsSearchEntry(tab: .general, title: "Show battery percentage inside icon", keywords: ["battery", "percentage", "inside", "icon", "general"], highlightID: SettingsTab.general.highlightID(for: "Show battery percentage inside icon")),
            SettingsSearchEntry(tab: .general, title: "Show desktop number", keywords: ["desktop", "number", "general"], highlightID: SettingsTab.general.highlightID(for: "Show desktop number")),
            SettingsSearchEntry(tab: .general, title: "Snap windows to screen edges", keywords: ["snap", "windows", "screen", "edges", "general"], highlightID: SettingsTab.general.highlightID(for: "Snap windows to screen edges")),
            SettingsSearchEntry(tab: .general, title: "Stay unlocked for", keywords: ["stay", "unlocked", "general"], highlightID: SettingsTab.general.highlightID(for: "Stay unlocked for")),
            SettingsSearchEntry(tab: .general, title: "System stats", keywords: ["system", "stats", "general"], highlightID: SettingsTab.general.highlightID(for: "System stats")),
            SettingsSearchEntry(tab: .gitCommit, title: "Add Repository…", keywords: ["add", "repository…", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Add Repository…")),
            SettingsSearchEntry(tab: .gitCommit, title: "Also commit uncommitted changes", keywords: ["also", "commit", "uncommitted", "changes", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Also commit uncommitted changes")),
            SettingsSearchEntry(tab: .gitCommit, title: "Commit Now", keywords: ["commit", "now", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Commit Now")),
            SettingsSearchEntry(tab: .gitCommit, title: "Commit at a random time", keywords: ["commit", "random", "time", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Commit at a random time")),
            SettingsSearchEntry(tab: .gitCommit, title: "Commits per day", keywords: ["commits", "per", "day", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Commits per day")),
            SettingsSearchEntry(tab: .gitCommit, title: "Message", keywords: ["message", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Message")),
            SettingsSearchEntry(tab: .gitCommit, title: "Not after", keywords: ["not", "after", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Not after")),
            SettingsSearchEntry(tab: .gitCommit, title: "Not before", keywords: ["not", "before", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Not before")),
            SettingsSearchEntry(tab: .gitCommit, title: "Push after committing", keywords: ["push", "after", "committing", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Push after committing")),
            SettingsSearchEntry(tab: .gitCommit, title: "Time of day", keywords: ["time", "day", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Time of day")),
            SettingsSearchEntry(tab: .gitCommit, title: "Vary the commit message", keywords: ["vary", "commit", "message", "git commit"], highlightID: SettingsTab.gitCommit.highlightID(for: "Vary the commit message")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Color-coded battery display", keywords: ["color-coded", "battery", "display", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Color-coded battery display")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Play feedback when volume is changed", keywords: ["play", "feedback", "volume", "changed", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Play feedback when volume is changed")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Scroll device name in HUD", keywords: ["scroll", "device", "name", "hud", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Scroll device name in HUD")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Show AirPods listening mode changes", keywords: ["airpods", "listening", "mode", "changes", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Show AirPods listening mode changes")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Show Bluetooth device connections", keywords: ["bluetooth", "device", "connections", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Show Bluetooth device connections")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Show battery percentage text in HUD", keywords: ["battery", "percentage", "text", "hud", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Show battery percentage text in HUD")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Use 3D Bluetooth HUD icon", keywords: ["bluetooth", "hud", "icon", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Use 3D Bluetooth HUD icon")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Use F1 and F2 for brightness", keywords: ["brightness", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Use F1 and F2 for brightness")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Use F10, F11 and F12 for volume", keywords: ["volume keys", "function keys", "external keyboard", "f10", "f11", "f12", "mute", "system hud"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Use F10, F11 and F12 for volume")),
            SettingsSearchEntry(tab: .hudAndOSD, title: "Use circular battery indicator", keywords: ["circular", "battery", "indicator", "hud and o s d"], highlightID: SettingsTab.hudAndOSD.highlightID(for: "Use circular battery indicator")),
            SettingsSearchEntry(tab: .launcher, title: "Open switcher", keywords: ["open", "switcher", "launcher"], highlightID: SettingsTab.launcher.highlightID(for: "Open switcher")),
            SettingsSearchEntry(tab: .launcher, title: "Open switcher backwards", keywords: ["open", "switcher", "backwards", "launcher"], highlightID: SettingsTab.launcher.highlightID(for: "Open switcher backwards")),
            SettingsSearchEntry(tab: .launcher, title: "Ring size", keywords: ["ring", "size", "launcher"], highlightID: SettingsTab.launcher.highlightID(for: "Ring size")),
            SettingsSearchEntry(tab: .liveActivities, title: "Caps Lock color", keywords: ["caps", "lock", "color", "live activities"], highlightID: SettingsTab.liveActivities.highlightID(for: "Caps Lock color")),
            SettingsSearchEntry(tab: .liveActivities, title: "Show Caps Lock Indicator", keywords: ["caps", "lock", "indicator", "live activities"], highlightID: SettingsTab.liveActivities.highlightID(for: "Show Caps Lock Indicator")),
            SettingsSearchEntry(tab: .liveActivities, title: "Show Caps Lock label", keywords: ["caps", "lock", "label", "live activities"], highlightID: SettingsTab.liveActivities.highlightID(for: "Show Caps Lock label")),
            SettingsSearchEntry(tab: .liveActivities, title: "Show Focus as brief toast", keywords: ["focus", "brief", "toast", "live activities"], highlightID: SettingsTab.liveActivities.highlightID(for: "Show Focus as brief toast")),
            SettingsSearchEntry(tab: .lockScreen, title: "Fullscreen artwork on right-click", keywords: ["fullscreen", "artwork", "right-click", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Fullscreen artwork on right-click")),
            SettingsSearchEntry(tab: .lockScreen, title: "Glass mode", keywords: ["glass", "mode", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Glass mode")),
            SettingsSearchEntry(tab: .lockScreen, title: "Hide active event and show next upcoming event", keywords: ["hide", "active", "event", "next", "upcoming", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Hide active event and show next upcoming event")),
            SettingsSearchEntry(tab: .lockScreen, title: "Keep album art visible during fullscreen artwork", keywords: ["keep", "album", "art", "visible", "during", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Keep album art visible during fullscreen artwork")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show countdown", keywords: ["countdown", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show countdown")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show event for entire duration", keywords: ["event", "entire", "duration", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show event for entire duration")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show events from all calendars", keywords: ["events", "all", "calendars", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show events from all calendars")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show events within the next", keywords: ["events", "within", "next", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show events within the next")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show focus widget", keywords: ["focus", "widget", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show focus widget")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show merged AirPlay and output devices", keywords: ["merged", "airplay", "output", "devices", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show merged AirPlay and output devices")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show next calendar event", keywords: ["next", "calendar", "event", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show next calendar event")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show start time after event begins", keywords: ["start", "time", "after", "event", "begins", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show start time after event begins")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show sunrise time", keywords: ["sunrise", "time", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show sunrise time")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show time remaining", keywords: ["time", "remaining", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show time remaining")),
            SettingsSearchEntry(tab: .lockScreen, title: "Use album art layout over fullscreen canvas", keywords: ["album", "art", "layout", "over", "fullscreen", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Use album art layout over fullscreen canvas")),
            SettingsSearchEntry(tab: .lockScreen, title: "Use enhanced liquid border", keywords: ["enhanced", "liquid", "border", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Use enhanced liquid border")),
            SettingsSearchEntry(tab: .media, title: "Enable media panel blur", keywords: ["media", "panel", "blur"], highlightID: SettingsTab.media.highlightID(for: "Enable media panel blur")),
            SettingsSearchEntry(tab: .media, title: "Enable real-time waveform", keywords: ["real-time", "waveform", "media"], highlightID: SettingsTab.media.highlightID(for: "Enable real-time waveform")),
            SettingsSearchEntry(tab: .media, title: "Fullscreen artwork on right-click", keywords: ["fullscreen", "artwork", "right-click", "media"], highlightID: SettingsTab.media.highlightID(for: "Fullscreen artwork on right-click")),
            SettingsSearchEntry(tab: .media, title: "Keep album art visible during fullscreen artwork", keywords: ["keep", "album", "art", "visible", "during", "media"], highlightID: SettingsTab.media.highlightID(for: "Keep album art visible during fullscreen artwork")),
            SettingsSearchEntry(tab: .media, title: "Lyrics timing", keywords: ["lyrics", "timing", "media"], highlightID: SettingsTab.media.highlightID(for: "Lyrics timing")),
            SettingsSearchEntry(tab: .media, title: "Per-app mute", keywords: ["per-app", "mute", "media"], highlightID: SettingsTab.media.highlightID(for: "Per-app mute")),
            SettingsSearchEntry(tab: .media, title: "Show media controls in Dynamic Island", keywords: ["media", "controls", "dynamic", "island"], highlightID: SettingsTab.media.highlightID(for: "Show media controls in Dynamic Island")),
            SettingsSearchEntry(tab: .media, title: "Show merged AirPlay and output devices", keywords: ["merged", "airplay", "output", "devices", "media"], highlightID: SettingsTab.media.highlightID(for: "Show merged AirPlay and output devices")),
            SettingsSearchEntry(tab: .media, title: "Show song title and artist in closed notch", keywords: ["song", "title", "artist", "closed", "notch", "media"], highlightID: SettingsTab.media.highlightID(for: "Show song title and artist in closed notch")),
            SettingsSearchEntry(tab: .media, title: "Translate lyrics", keywords: ["translate", "lyrics", "media"], highlightID: SettingsTab.media.highlightID(for: "Translate lyrics")),
            SettingsSearchEntry(tab: .media, title: "Use album art layout over fullscreen canvas", keywords: ["album", "art", "layout", "over", "fullscreen", "media"], highlightID: SettingsTab.media.highlightID(for: "Use album art layout over fullscreen canvas")),
            SettingsSearchEntry(tab: .menuBar, title: "Add an always-hidden section", keywords: ["add", "always-hidden", "section", "menu bar"], highlightID: SettingsTab.menuBar.highlightID(for: "Add an always-hidden section")),
            SettingsSearchEntry(tab: .menuBar, title: "Expand on hover", keywords: ["expand", "hover", "menu bar"], highlightID: SettingsTab.menuBar.highlightID(for: "Expand on hover")),
            SettingsSearchEntry(tab: .menuBar, title: "Hide again after", keywords: ["hide", "again", "after", "menu bar"], highlightID: SettingsTab.menuBar.highlightID(for: "Hide again after")),
            SettingsSearchEntry(tab: .menuBar, title: "Show Items", keywords: ["items", "menu bar"], highlightID: SettingsTab.menuBar.highlightID(for: "Show Items")),
            SettingsSearchEntry(tab: .menuBar, title: "Show or hide", keywords: ["hide", "menu bar"], highlightID: SettingsTab.menuBar.highlightID(for: "Show or hide")),
            SettingsSearchEntry(tab: .notes, title: "Sync Now", keywords: ["sync", "now", "notes"], highlightID: SettingsTab.notes.highlightID(for: "Sync Now")),
            SettingsSearchEntry(tab: .notes, title: "Sync with Apple Notes", keywords: ["sync", "apple", "notes"], highlightID: SettingsTab.notes.highlightID(for: "Sync with Apple Notes")),
            SettingsSearchEntry(tab: .terminal, title: "Font family", keywords: ["font", "family", "terminal"], highlightID: SettingsTab.terminal.highlightID(for: "Font family")),
            SettingsSearchEntry(tab: .terminal, title: "Keep terminal open", keywords: ["keep", "terminal", "open"], highlightID: SettingsTab.terminal.highlightID(for: "Keep terminal open")),
            SettingsSearchEntry(tab: .timer, title: "Custom timer style", keywords: ["custom", "timer", "style"], highlightID: SettingsTab.timer.highlightID(for: "Custom timer style")),
            SettingsSearchEntry(tab: .timer, title: "Show preset list in timer tab", keywords: ["preset", "list", "timer", "tab"], highlightID: SettingsTab.timer.highlightID(for: "Show preset list in timer tab")),
            SettingsSearchEntry(tab: .timer, title: "Timer controls appear as", keywords: ["timer", "controls", "appear"], highlightID: SettingsTab.timer.highlightID(for: "Timer controls appear as")),
            SettingsSearchEntry(tab: .todo, title: "Clear Completed", keywords: ["clear", "completed", "todo"], highlightID: SettingsTab.todo.highlightID(for: "Clear Completed")),
            SettingsSearchEntry(tab: .todo, title: "Show completed items", keywords: ["completed", "items", "todo"], highlightID: SettingsTab.todo.highlightID(for: "Show completed items")),
            SettingsSearchEntry(tab: .vinyl, title: "Backing", keywords: ["backing", "vinyl"], highlightID: SettingsTab.vinyl.highlightID(for: "Backing")),
            SettingsSearchEntry(tab: .vinyl, title: "Layer", keywords: ["layer", "vinyl"], highlightID: SettingsTab.vinyl.highlightID(for: "Layer")),
            SettingsSearchEntry(tab: .vinyl, title: "Progress style", keywords: ["progress", "style", "vinyl"], highlightID: SettingsTab.vinyl.highlightID(for: "Progress style")),
            SettingsSearchEntry(tab: .vinyl, title: "Show progress", keywords: ["progress", "vinyl"], highlightID: SettingsTab.vinyl.highlightID(for: "Show progress")),
            SettingsSearchEntry(tab: .vinyl, title: "Show the tonearm", keywords: ["tonearm", "vinyl"], highlightID: SettingsTab.vinyl.highlightID(for: "Show the tonearm")),
