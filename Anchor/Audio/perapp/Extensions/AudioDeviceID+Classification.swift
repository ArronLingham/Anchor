...
nonisolated extension AudioDeviceID {
    ...
    ///
    /// Used to *flatten* a user-created aggregate before wrapping it in Anchor's own
    ...
    /// channels), so the sub-devices must be expanded into Anchor's aggregate directly.
