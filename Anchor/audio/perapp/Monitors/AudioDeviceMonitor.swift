...
final class AudioDeviceMonitor: AudioDeviceProviding {
    ...
    private let logger = os.Logger(subsystem: Bundle.main.bundleIdentifier ?? "Anchor", category: "AudioDeviceMonitor")
    ...
    private func refresh() {
        do {
            ...
            for deviceID in deviceIDs {
                ...
                // Anchor's own internal aggregates (used for process taps) are
                ...
                // etc.) pass through.
                if deviceID.isAggregateDevice() && name.hasPrefix("Anchor-") { continue }
