...
final class ProcessTapController: ProcessTapControlling {
    ...
    init(
        ...
        self.logger = os.Logger(subsystem: Bundle.main.bundleIdentifier ?? "Anchor", category: "ProcessTapController(\(app.name))")
    }
    ...
    /// Resolved plan for Anchor's private wrapping aggregate: which hardware sub-devices
    ...
    private func buildAggregateDescription(outputUIDs: [String], tapUUID: UUID, name: String) -> [String: Any] {
        ...
        let plan = Self.planAggregate(
            ...
            expand: { uid in
                ...
                // be flattened into Anchor's aggregate (nested aggregates aren't supported).
