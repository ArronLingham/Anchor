...
final class MacBatteryManager {
    ...
    func currentStatus() -> BatteryStatus {
        ...
        for source in sourcesList {
            ...
            // Time-to-full while charging, time-to-empty while on battery.
            // Reading only the former meant the figure was blank exactly when
            // it matters most — on battery, wondering how long is left.
            // IOKit reports -1 while it is still calculating, which must not be
