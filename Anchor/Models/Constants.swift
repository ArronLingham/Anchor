...
extension Defaults.Keys {
    ...
    static let showDisconnectedBatteryHUD = Key<Bool>("showDisconnectedBatteryHUD", default: true)
    ...
    static let disconnectedBatteryHUDDuration = Key<Int>("disconnectedBatteryHUDDuration", default: 3)
    ...
    static let enableNotificationMirroring = Key<Bool>("enableNotificationMirroring", default: false)
